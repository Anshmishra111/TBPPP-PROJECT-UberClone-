...
const CaptionSignup = () => {
  ...
  return(
    ...
    <div>
        <img className ='w-20 m-3' src ="https://www.svgrepo.com/show/505031/uber-driver.svg" alt="Uber Logo" />
    <form onSubmit={(e)=>{
        submitHandler(e)
    }}>

      <h3 className="text-base font-lg mb-2">What's Your name</h3>
      ...
      <h3 className="text-base font-lg mb-2">What's Your email</h3>
      <input 
      value={email}
      onChange={(e)=>{
      ...
      <p className="text-center">Already have a account? <Link to='/caption-login' className="text-blue-500 text-center">Login Here</Link></p>
      </form>
    </div>
    <div>
